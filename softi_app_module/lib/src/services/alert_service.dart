...
class AlertService extends IAlertService {
  ...
  // Future<AlertResponse> showWarningDialog(
  //   String title,
  //   String message, {
  //   bool needConfirmation = false,
  // }) {
  ...
  // Future<AlertResponse> showWarningToast(String title, String message) {
  //   return showToast(title: title, message: message, status: DialogStatus.warning);
  // }
